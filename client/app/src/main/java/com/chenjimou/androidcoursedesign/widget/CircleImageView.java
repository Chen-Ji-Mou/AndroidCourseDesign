...
public class CircleImageView extends ImageView
{
	...
	private static final int DEFAULT_BG_COLOR = 0x6D6F72;
	...
	private void setup()
	{
		...
		mBgRadius = Math.min((mBorderRect.height() - mBorderWidth) / 2, (mBorderRect.width() - mBorderWidth) / 2);
	...
	public void refreshDrawableState()
	{
		...
		if (getDrawable() != null)
		{
			mBitmap = getBitmapFromDrawable(getDrawable().getCurrent());
			setup();
		}
